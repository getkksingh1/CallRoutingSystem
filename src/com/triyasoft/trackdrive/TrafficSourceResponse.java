...
public class TrafficSourceResponse {
	...
	public static void main(String[] args) throws JsonSyntaxException,
		...
		TrafficSourceResponse callsResponse = gson
				.fromJson(
						new FileReader(
								"/Users/abc/Documents/workspace/CallTracker/src/com/triyasoft/trackdrive/trafficsourcejson"),
						TrafficSourceResponse.class);
		...
		for (TrafficSource tdTrafficSource : trafficSources) {
			...
			sourceModel.setLast_name(tdTrafficSource
					.getUser_traffic_source_id());
			sourceModel.setIs_Active(1);

			TrackDriverDBUtility.addTrafficSourceViaDirectDBConnection(
					sourceModel, conn);
