...
public class TrackDriverDBUtility {
	...
	public static Buyer addBuyerViaDirectDBConnection (Buyer buyer, Connection conn) {
	...
	public static PhoneNumber addPhoneNumberVidDirecDBConnection(PhoneNumber phoneNumber, Connection conn) {
	...
	public static TrafficSource addTrafficSourceViaDirectDBConnection( TrafficSource trafficSource, Connection conn) {
		   ...
		   PreparedStatement stmt = null;
		            ...
		            stmt = conn.prepareStatement("INSERT INTO trafficsources (id, first_name,last_name,is_active)  VALUES (?, ?,?,?)");
		            int counter =1;
