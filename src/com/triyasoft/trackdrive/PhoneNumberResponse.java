...
public class PhoneNumberResponse {
	...
	public static void main(String[] args) throws JsonSyntaxException,
		...
		PhoneNumberResponse phoneNumberResponse = gson
				.fromJson(
						new FileReader(
								"/Users/abc/Documents/workspace/CallTracker/src/com/triyasoft/trackdrive/phonenumbersjson"),
		...
		for (PhoneNumber tdphoneNumber : numbers) {
			...
			if (trafficsourceid == null || trafficsourceid.trim().length() == 0
					|| "null".equals(trafficsourceid.trim()))
				trafficsourceid = "0";

			trackerPhoneModel.setTraffic_source_id(Integer
					.parseInt(trafficsourceid));
			...
			TrackDriverDBUtility.addPhoneNumberVidDirecDBConnection(
					trackerPhoneModel, conn);
