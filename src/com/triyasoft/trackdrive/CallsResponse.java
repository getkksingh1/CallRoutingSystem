...
public class CallsResponse {
	...
	public static void main(String[] args) throws JsonSyntaxException, JsonIOException, FileNotFoundException {
		...
		/*if(true) {
			String data ="2017-06-22T07:47:40.772+00:00";
			System.out.println(convertToDate(data));
			return;
		}
		*/
		Gson gson = new Gson();

		CallsResponse callsResponse = gson.fromJson(new FileReader("/Users/abc/Documents/workspace/CallTracker/src/com/triyasoft/trackdrive/trackercallsjson.txt"), CallsResponse.class);
