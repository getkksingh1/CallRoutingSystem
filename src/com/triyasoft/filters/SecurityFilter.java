...
public class SecurityFilter implements Filter{
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (user == null) {
		    String uuid = getCookieValue(request, Constans.REMEMBER_ME_COOKIE_NAME);
		    ...
		    if (uuid != null) {
		        ...
		        //    request.login(user.getUserid() , user.getPassword());
		            ...
		            addCookie(response, Constans.REMEMBER_ME_COOKIE_NAME, uuid, Constans.REMEMBER_ME_COOKIE_TIME_OUT); // Extends age.
		        } else {
