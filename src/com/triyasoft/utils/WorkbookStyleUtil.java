...
public class WorkbookStyleUtil {
	...
	public static void decorateBuyerSummaryHeaderCell(XSSFWorkbook workbook,
			XSSFSheet sheet, Cell headerCellUuid, int headerCharwidth,
			int columnNumber) {
	...
	public static void decorateBuyerSummaryFooterCell(XSSFWorkbook workbook,
			XSSFSheet sheet, Cell headerCellUuid, int headerCharwidth,
			int columnNumber, boolean alightRightcenter) {
	...
	public static void decorateSourceSummaryHeaderCell(XSSFWorkbook workbook,
			XSSFSheet sheet, Cell headerCellUuid, int headerCharwidth,
			int columnNumber) {
	...
	public static void decorateSourceSummaryFooterCell(XSSFWorkbook workbook,
			XSSFSheet sheet, Cell headerCellUuid, int headerCharwidth,
			int columnNumber) {
