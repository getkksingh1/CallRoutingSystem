  ...
  static void initiateCallRecording(final String calluuid){
    myExecutor.execute(new Runnable() {
		...
		private void fireCall(String uuid1) {
			...
			params.put("fallback_url","http://52.42.152.129/"+appContext+"/plivooutboundcall?requestType=fallback&legBId="+legBId+"&conferenceID="+conferenceID+"&parentuuid="+uuid);
			params.put("hangup_url","http://52.42.152.129/"+appContext+"/plivooutboundcall?requestType=hangup&legBId="+legBId+"&conferenceID="+conferenceID+"&parentuuid="+uuid);
			params.put("ring_url","http://52.42.152.129/"+appContext+"/plivooutboundcall?requestType=ring&legBId="+legBId+"&conferenceID="+conferenceID+"&parentuuid="+uuid);
			params.put("answer_url","http://52.42.152.129/"+appContext+"/plivooutboundcall?requestType=answer&legBId="+legBId+"&conferenceID="+conferenceID+"&parentuuid="+uuid);
			params.put("url","http://52.42.152.129/"+appContext+"/plivooutboundcall?requestType=answer&legBId="+legBId+"&conferenceID="+conferenceID+"&parentuuid="+uuid);
