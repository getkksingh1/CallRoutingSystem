...
public static void main(String[] args) throws Exception{
    ...
    RestAPI api = new RestAPI(auth_id, auth_token, "v1");
     ...
     parameters.put("app_id","91076396410618848"); // ID of the application for which has to be modified
 //    parameters.put("answer_url", "http://exampletest.com"); // Values that have to be updated
     parameters.put("answer_url", "http://52.42.152.129/amit/plivo?requestType=answer"); // Values that have to be updated
