...
public class PlivoPhoneNumbers {
	...
	public static List<Number> loadAllPlivoNumbers() {
		...
		parameters.put("limit", "20"); // Used to display the number of results
										// per page.
		parameters.put("offset", "0"); // Denotes the number of value items by
										// which the results should be offset.
		...
		try {
			...
			parameters.put("limit", "20"); // Used to display the number of
											// results per page.
			parameters.put("offset", "20"); // Denotes the number of value items
											// by which the results should be
											// offset.
