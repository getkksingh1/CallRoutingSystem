...
public class XPlivoSignature {
	...
	public static void main(String[] args) throws PlivoException {
		...
		System.out.println(getSignedHash("http://52.42.152.129/CallTracker/plivo?requestType=hangupBillDuration0BillRate0.021CallStatusno-answerCallUUIDa633d74c-5e6a-11e7-885a-0d39f994073eCallerNameskypeDirectioninboundDuration0EndTime2017-07-01 14:36:20EventHangupFrom16613804714HangupCauseCALL_REJECTEDStartTime2017-07-01 14:36:20To18662145075TotalCost0.00000requestTypehangup", "YmI0MmZkZmUwZTBmNmM5ZmFhNjllNjM4MzEzZDAz"));
		
	}
	
   public static void auditPlivoSignature(HttpServletRequest request, String additionalParam) {
