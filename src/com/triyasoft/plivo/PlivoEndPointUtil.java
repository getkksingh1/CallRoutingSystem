...
public class PlivoEndPointUtil {
	...
	public static List<Endpoint> getAllEndpointsStatus() {
		...
		parameters.put("offset", "0"); // The number of value items by which the
										// results should be offset
	...
	public static PlivoEndpointExtention createPlivoEndPoint(
			PlivoEndpointExtention endpointExtention) {

		RestAPI api = new RestAPI(auth_id, auth_token, "v1");

		LinkedHashMap<String, String> parameters = new LinkedHashMap<String, String>();
		parameters.put("username",
				endpointExtention.getPlivo_endpoint_user_name()); // The
																	// username
																	// for the
																	// endpoint
																	// to be
		...
		parameters.put("password",
				endpointExtention.getPlivo_endpoint_user_password()); // The
																		// password
																		// for
																		// your
																		// endpoint
		...
		parameters.put("alias",
				endpointExtention.getPlivo_endpoint_user_alias()); // Alias for
																	// this
																	// endpoint
	...
	public static void deletePlivoEndPoint(String plivoEndPointid) {
		...
		LinkedHashMap<String, String> parameters = new LinkedHashMap<String, String>();
		parameters.put("endpoint_id", plivoEndPointid); // ID of the endpoint
														// that as to be deleted
