...
public class TrafficSourceServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		if ("updateSource".equals(requestType)) {
			...
			TrafficSourceDaoService.updateSource(id, first_name, last_name,
					is_active);
		...
		if ("addSource".equals(requestType)) {
			...
			TrafficSource buyer = TrafficSourceDaoService.addTrafficSource(
		...
		if ("loadSourcesOption".equals(requestType)) {
			...
			for (TrafficSource source : lst) {
				...
				option.setDisplayText(source.getFirst_name() + ":"
						+ source.getLast_name());
