...
public class RoleBasedDashboardServlet extends HttpServlet  {
	...
	public static long lasttimeDashBoardDataFectched = System.currentTimeMillis();
	 ...
	 private void loadData() {
		 ...
		 long duration  =  System.currentTimeMillis() - DashboardServlet.lasttimeDashBoardDataFectched;
	    ...
	    protected void service(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
					...
					if("headersummary".equals(requestType)) {
						...
						String content = dashboardUIGenerator.generateHeaderStripRoleBased(hsm);
					...
					if("maincontainer".equals(requestType)) {
					 ...
					 TrafficSourcesSummary trafficSourcesSummary =	ddm.getTrafficSourcesSummary();
						...
						Collections.sort(trafficSourcesSummary.getSourceSummaries());   
						 ...
						 String daashboardPartialUI =  dashboardUIGenerator.generateRoleBasedDashBoardPartialUI(ddm);
					...
					if("testcontainer".equals(requestType)) {
						...
						String daashboardPartialUI =  dashboardUIGenerator.generateDashBoardPartialUI(dashboardDataModel);
	...
	private int getActiveCalls(HttpServletRequest request) {
		 ...
		 for (CallModel todayCall : todaysCalls) {
			 int[] userAccountIds  = user.getAccount_id();
			 for(int i = 0 ; i < userAccountIds.length; i++) {
			 if(todayCall.getIs_running() == 1 && (userAccountIds[i] ==  todayCall.getTraffic_source_id()))
				 counter++;
			 }
		}
