	    ...
	    protected void service(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
					...
					if("exportToExcel".equals(requestType)) {
						...
						List<CallModel> calls = ReportsDao.loadAllCall(buyerId, sourceId, startdate, endDate);
						 ...
						 try
					        {
							    ...
							    Workbook workbook = DailyReportUtil.loadyesterDayReportWorkbook(startdateInput, endDateInput);
							    String reportNamePrefix =  startdateInput.replace("-", "")+endDateInput.replace("-", "");
					         	response.setHeader("Content-Disposition", "attachment; filename=report"+reportNamePrefix+".xlsx");
					            response.setContentType("application/vnd.ms-excel");
						 ...
						 try
					        {
							    ...
							    Workbook workbook = DailyReportUtil.loadyesterDayReportWorkbookForSource(startdateInput, endDateInput,accountids);
							    String reportNamePrefix =  startdateInput.replace("-", "")+endDateInput.replace("-", "");
					         	response.setHeader("Content-Disposition", "attachment; filename=report"+reportNamePrefix+".xlsx");
					            response.setContentType("application/vnd.ms-excel");
