...
public class PhoneNumberServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		if ("loadNumbersByTrafficSource".equals(requestType)) {
			...
			lst = PhoneNumberDaoService
					.loadAllNumbersByTrafficSourceId(trafficsource);
		...
		if ("updateNumber".equals(requestType)) {
			...
			String traffic_source_id = request
					.getParameter("traffic_source_id");
			...
			PhoneNumberDaoService.updateNumber(id, number, traffic_source_id,
					is_active, costpercall);
		...
		if ("addNumber".equals(requestType)) {
			...
			PhoneNumber phoneNumber = PhoneNumberDaoService.addPhoneNumber(
					number, traffic_source_id, is_active, costpercall);
