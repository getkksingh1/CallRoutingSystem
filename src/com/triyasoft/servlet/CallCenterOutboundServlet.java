	 ...
	 @Override
	    protected void service(HttpServletRequest request, HttpServletResponse response)
			...
			if("answer".equals(requestType)) {
				...
				String xmlResponse = "<Response>  <Dial callerId=\""+callerId+"\"><Number>"+to+"</Number> </Dial> </Response>";
				
				System.out.println("Getting Inside CallCenterOutboundServlet answer ");
				printRequestparameters(request);

			    AuditDao.auditHttpRequest("CallCenterOutboundServletAnswer", request);
			...
			if("hangup".equals(requestType)) {
    				...
    				System.out.println("Getting Inside CallCenterOutboundServlet Hangup ");

    				printRequestparameters(request);

				    AuditDao.auditHttpRequest("CallCenterOutboundServletHangup", request);
				    ...
				    CallcenterOutboundCallsDao.updateOutboundCall(totalCost,billDuration,billRate,duration,hangupCause,callStatusAtHangup,uuid);
