	    ...
	    protected void service(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
					...
					if("deleteExtension".equals(requestType)) {
						...
						String plivo_endpoint_user_name = request.getParameter("plivo_endpoint_user_name");
						System.out.println("plivo_endpoint_user_name:"+plivo_endpoint_user_name);

						String plivo_endpoint_user_password = request.getParameter("plivo_endpoint_user_password");
						System.out.println("plivo_endpoint_user_password:"+plivo_endpoint_user_password);
						...
						endpointExtention.setPlivo_endpoint_user_name(plivo_endpoint_user_name);
						endpointExtention.setPlivo_endpoint_user_password(plivo_endpoint_user_password);
						endpointExtention.setIsactive(Integer.parseInt(is_active));
							
						endpointExtention  = PlivoEndPointUtil.createPlivoEndPoint(endpointExtention);
						

						String sipurl = "sip:"+endpointExtention.getPlivo_endpoint_user_id()+"@"+endpointExtention.getPlivo_end_point_domain();
