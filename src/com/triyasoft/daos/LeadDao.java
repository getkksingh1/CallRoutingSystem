...
public class LeadDao {
	...
	public static void createLead(LeadModel leadModel) {
		...
		try {
			...
			stmt = conn
					.prepareStatement("insert into leads (email,companyname,firstname,lastname,skype_name,phonenumber,addressline1,addressLine2,zip,city,state,country,request_demo) "
							+ "values (?,?,?,?,?,?,?,?,?,?,?,?,?) ");
