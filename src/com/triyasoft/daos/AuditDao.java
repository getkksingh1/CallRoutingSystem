...
public class AuditDao {
	...
	public static void auditHttpRequest(String audit_type, HttpServletRequest request) {
	...
	public static void auditRecord(String audit_type, String audit_value) {
		   ...
		   PreparedStatement stmt = null;
 	       Connection conn = ProjectUtils.getMySQLConnection();
		            ...
		            stmt = conn.prepareStatement("INSERT INTO audit_log ( audit_type,audit_value)  VALUES (?,?)");
		            int counter =1;
	...
	public static void auditPlivoSignature(String uuid, String uri, String plivoSignature, String mySignatureHash) {
	       ...
	       Connection conn = ProjectUtils.getMySQLConnection();
		            ...
		            stmt = conn.prepareStatement("INSERT INTO plivosignature  ( uuid, uri, plivosignature, myignaturehash)  VALUES (?,?,?,?)");
		            int counter =1;
