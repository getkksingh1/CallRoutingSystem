...
public class BuyersSummaryReportModel {


	Map<Integer, BuyerReportSummary> buyersSummary = new HashMap<Integer, BuyerReportSummary>();
	...
	public	BuyerReportSummary getTrafficSourceSummaryInstance() {
			return new BuyerReportSummary();
		}
	
	public Map<Integer, BuyerReportSummary> getBuyerSummary() {
		return buyersSummary;
	}

	public void setTrafficSourcesSummary(
			Map<Integer, BuyerReportSummary> buyersSummary) {
		this.buyersSummary = buyersSummary;
	}

	
	public class BuyerReportSummary {
