...
public class DashboardDataModel {
		 ...
		 public BuyerSummary getBuyerSummaryInstance() {
		  ...
		  public class BuyerSummary implements Comparable<BuyerSummary>{
			...
			public void addToBuyersMinute(double duration) {
				this.todaysCalltimeTobuyer = this.todaysCalltimeTobuyer  + duration ;
	...
	public class TrafficSourcesSummary {
		...
		public	class TrafficSourceSummary  implements Comparable<TrafficSourceSummary>{
		...
		public void setSourceSummaries(List<TrafficSourceSummary> sourceSummaries) {
	...
	public class BuyerConversion  {
		...
		public void printValues() {
		    ...
		    System.out.println(this.buyerConvetedPercentageToday+"\t"+this.buyerConvertedToday+"/"+this.totalCallsToday+"\t Today");
		    System.out.println(this.buyerConvertedPercentageYday+"\t"+this.buyerConvertedYday+"/"+this.totaslCallsYday+"\t Yesterday");
		    System.out.println(this.buyerConvertedPercentage4Hrs+"\t"+this.buyerConverted4Hrs+"/"+this.totaslCalls4Hrs+"\t 4 Hrs");
		    System.out.println(this.buyerConvertedPercentage1Hrs+"\t"+this.buyerConverted1Hrs+"/"+this.totaslCalls1Hrs+"\t 1 Hrs");
		...
		public void setBuyerConvetedPercentageToday(double buyerConvetedPercentageToday) {
		...
		public void setBuyerConvertedPercentageYday(double buyerConvertedPercentageYday) {
		...
		public void setBuyerConvertedPercentage4Hrs(double buyerConvertedPercentage4Hrs) {
		...
		public void setBuyerConvertedPercentage1Hrs(double buyerConvertedPercentage1Hrs) {
	...
	public class OnGoingCalls {
		...
		public void printValues() {
			...
			System.out.println(this.activeCCPercentage+"\t"+this.activeCC+"/"+this.maxActiveCC+"\t Active CC");
			System.out.println(this.pausedCCPercentage+"\t"+this.pausedCC+"/"+this.maxPausedCC+"\t Paused CC ");
			System.out.println("-------------------------------");
	...
	public void setTrafficSourcesSummary(TrafficSourcesSummary trafficSourcesSummary) {
