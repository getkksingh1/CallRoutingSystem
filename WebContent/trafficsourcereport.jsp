...
<head>
    ...
    function reloadReport() {
    	...
    	window.location = "trafficsourcereport.jsp?startdate="+startdate+"&endDate="+endDate;
...
%>
 ...
 <td>
 <input type="text" id="datepicker1" name="startdate"  style=" padding: 7px; border: solid 0px #672;transition: box-shadow 0.3s, border 0.3s;background: #779126;color: white;">
  </td>
  <td  style="background: #f3f3f3;width: 10%; font-weight:500; font-family:'Roboto', sans-serif">   
        End Date: 
   </td>
