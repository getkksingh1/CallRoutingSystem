...
if( user ==null || user.getUserroleid() != 1)
{
 ...
 %>
    ...
    <div id="StudentTableContainer" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px;color: #333;">
</div>
<script type="text/javascript">

    var cachedCityOptions = null;
    
    var trafficSourcesMessages = {
    	    serverCommunicationError: 'An error occured while communicating to the server.',
    	    loadingMessage: 'Loading Traffic Sources...',
    	    noDataAvailable: 'No data available!',
    	    addNewRecord: 'Add New Source',
    	    editRecord: 'Edit Traffic Source',
    ...
    $(document).ready(function () {
        ...
        $('#StudentTableContainer').jtable({
        	messages: trafficSourcesMessages,
            title: 'Traffic Sources',
            deleteConfirmation: function(data) {
            	    data.deleteConfirmMessage = 'Are you sure to delete Traffic Source ' + data.record.first_name + ' '+ data.record.last_name +'?';
            	},
            paging: false,
            sorting: true,
            multiSorting: true,
            ...
            actions: {
                listAction: function (postData, jtParams) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'sources?requestType=loadSources&abac=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize + '&jtSorting=' + jtParams.jtSorting,
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                ...
                deleteAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'sources?requestType=deleteSource',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                            success: function (data) {
                ...
                createAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'sources?requestType=addSource',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                            success: function (data) {
                ...
                updateAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'sources?requestType=updateSource',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                            success: function (data) {
