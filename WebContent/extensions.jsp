...
var filterMessages = {
    ...
    addNewRecord: 'Add new Extension',
    editRecord: 'Edit Extension',
    ...
    $(document).ready(function () {
        ...
        $('#StudentTableContainer').jtable({
            ...
            deleteConfirmation: function(data) {
            	    data.deleteConfirmMessage = 'Are you sure to delete Extension ?';
            	},
            actions: {
                listAction: function (postData, jtParams) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'extension?requestType=loadExtension&abac=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize + '&jtSorting=' + jtParams.jtSorting,
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                ...
                deleteAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'extension?requestType=deleteExtension',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                            success: function (data) {
                ...
                createAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: 'extension?requestType=addExtension',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
                            success: function (data) {
