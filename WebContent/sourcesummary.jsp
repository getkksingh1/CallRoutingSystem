...
<%@page import="com.triyasoft.model.TrafficSourceSummaryReportModel"%>
...
<head>
    ...
    function reloadReport() {
    	...
    	window.location = "sourcesummary.jsp?startdate="+startdate+"&endDate="+endDate+"&sourceId="+sourceId;
    ...
    $( function() {
    	...
    	if(sourceId !=null)
    	out.println("$( \"#sourceId\" ).val('"+sourceId+"');");
    	...
    	if(endDate == null) {
    		...
    		endDate =  dateFormat.format(new Date(today.getTime()+86400*1000));
    	}
...
<div  class="filtering" style="width:100%">
    <table>
    <tr>
    <td style="background: #f3f3f3;width: 10%; font-weight:500; font-family:'Roboto', sans-serif">
            <label for="sourceId">Source:</label>
    </td>
    <td>
    <div class="styled-select green rounded">
    
      <select id="sourceId" name="sourceId" style="color:white">
...
<td style="background: #f3f3f3;width: 10%; font-weight:500; font-family:'Roboto', sans-serif">
        ...
        <td> <input type="text" id="datepicker1" name="startdate"  style=" padding: 7px; border: solid 0px #672;transition: box-shadow 0.3s, border 0.3s;background: #779126;color: white;">
        </td>
        
        <td></td>
        
       <td style="background: #f3f3f3;width: 10%; font-weight:500; font-family:'Roboto', sans-serif"> End Date: </td> 
       <td>
        <input type="text" id="datepicker2" name="enddate"  style=" padding: 7px; border: solid 0px #672;transition: box-shadow 0.3s, border 0.3s;background: #779126;color: white;">
        </td>
     
        <td>
       <button class="btn" type="submit" id="LoadRecordsButton" onclick="reloadReport();">Pull Report</button>
  </td>
  </tr>
...
<div class="divTableCell" style="background-color:#eee; font-weight:700">Date</div>
...
TrafficSourceSummaryReportModel tssrm =  DailyReportUtil.getTrafficSourceSummary(request);
TreeMap<String, TrafficSourceSummary> datewiseSummary = tssrm.getSourceSummaryMap();
int totalCalls = tssrm.getTotalCalls();


Iterator it = datewiseSummary.entrySet().iterator();
int counter= 0;
